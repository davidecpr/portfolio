...
(async () => {
	...
	// Read the JSON data dynamically to avoid using the "assert { type: 'json' }" syntax
	...
	try {
		...
		console.warn('⚠️  favicon.ico not found, skipping removal.');
	}

	// Merge the existing data.json content with the default template data
